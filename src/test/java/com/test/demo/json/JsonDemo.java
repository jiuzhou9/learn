...
public class JsonDemo {
    ...
    public void test02(){
        ...
        Result<Student> studentResult = Result.buildSuccess(student);

        String string = JSON.toJSONString(studentResult);
        System.out.println(string);
...
//        Student stu = (Student) jsonObject.get("object");   错误解析
        JSONObject object = jsonObject.getJSONObject("object");//解析到student数据
        List<Address> adds = (List<Address>) object.get("addresses");//解析到addresses数据
        System.out.println("addresses:"+adds);
